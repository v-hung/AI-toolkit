...
Generate `./01_Requirements_Document/04_business_rules.md` from all generated Use Case files and supporting documents.
...
- `./01_Requirements_Document/03_usecases/plan.md` — to identify which UC files exist (`[x]` entries)
- `./01_Requirements_Document/03_usecases/M[MM]_[slug].md` — all files marked `[x]` in plan
- `./01_Requirements_Document/02_features.md` — for `Excludes` fields
- `./01_Requirements_Document/project-overview.md` — for system-level constraints
...
Write to: `./01_Requirements_Document/04_business_rules.md`
...
<!-- source: 03_usecases/*.md, 02_features.md, project-overview.md -->
<!-- total: [N] rules -->
...
**Source:** UC[MM].[NN].[PP] EF[NN] / UC[MM].[NN].[PP] Preconditions / 02_features.md Excludes
...
**Source:** Cite exact location — `UC01.02.01 EF01`, `UC01.03.02 Preconditions`, `02_features.md F02.01 Excludes`, `project-overview.md`. Multiple sources allowed.
...
- Do not include rules already marked as out-of-scope in `02_features.md`
