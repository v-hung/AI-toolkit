...
Generate `./01_Requirements_Document/03_usecases/M[MM]_[slug].md` for the specified module.
...
If no argument → read `./01_Requirements_Document/03_usecases/plan.md` and find the first entry where status is `[ ]`.
...
- `./01_Requirements_Document/03_usecases/plan.md`
- `./01_Requirements_Document/02_features.md`
- `./01_Requirements_Document/project-overview.md`
...
- Scope from `02_features.md` Includes field
...
Write to: `./01_Requirements_Document/03_usecases/M[MM]_[slug].md`
