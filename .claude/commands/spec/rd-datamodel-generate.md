...
Generate `./01_Requirements_Definition/data_model.md` from Use Case files and Business Rules.
...
- `./01_Requirements_Definition/business_rules.md` — for constraints on entities
- `./01_Requirements_Definition/project-overview.md` — for system-level context only
...
For each entity and attribute, check `business_rules.md`:
...
Write to: `./01_Requirements_Definition/data_model.md`
